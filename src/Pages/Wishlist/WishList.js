...
const WishList = () => {
    ...
    return (
        <div className='h-[100vh]'>
            ...
            {
                cart?.cartItems?.length == 0 ? <p className='text-center my-20'>No wishlist product find...</p> : <div className='grid grid-cols-4 max-w-6xl mx-auto gap-7 pb-12 pt-6'>
                    {
                                ...
                                >
                                    ...
                                    <div className="pt-6 h-40 px-5 items-center text-center text-black">
                                        ...
                                        <div className="py-6">
                                            ...
                                            <p className='text-[12px] py-2 underline hover:text-blue-500 cursor-pointer' onClick={() => deleteItemFromCart(e.product)}>Remove From Wishlist</p>
                                        </div>
