...
export default function Example() {
  return (
    <div className="w-full px-4 pt-16 grid grid-cols-1 lg:grid-cols-2 items-center">
      <div
        className="mx-auto w-full max-w-2xl rounded-none bg-transparent p-2"
      ...
      >
        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className="flex w-full justify-between rounded-[4px] bg-purple-100 px-4 py-2 text-left text-sm font-medium text-blue-800 hover:bg-purple-200 focus:outline-none focus-visible:ring focus-visible:ring-blue-500 focus-visible:ring-opacity-75">
                <span>
